locals {
  ...
  cluster_name_prefix = "${local.common["project_name_prefix"]}-${terraform.workspace}-${local.workspace_common["region_code"]}"
  service_name_prefix = "${terraform.workspace}-${local.common["project_name_prefix"]}"
